...
public partial class AkademiQportfolioDbContext : DbContext
{
    public AkademiQportfolioDbContext()
    {
    }

    public AkademiQportfolioDbContext(DbContextOptions<AkademiQportfolioDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("server=DESKTOP-NH5EP7F\\YUNUSSQLSERVER;database=AkademiQPortfolioDb;integrated security=true;trustServerCertificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.HobbyId).HasName("PK_Hobbys");

            entity.Property(e => e.IconUrl).HasMaxLength(50);
            entity.Property(e => e.Title).HasMaxLength(50);
        });
